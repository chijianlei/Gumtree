...
public class Pruning {
	...
	private ArrayList<PruneTuple> pts1 = new ArrayList<PruneTuple>();
	private ArrayList<PruneTuple> pts2 = new ArrayList<PruneTuple>();
	...
	public void pruneTree() throws Exception {
		...
		List<ITree> results1 = new ArrayList<ITree>();
		List<ITree> results2 = new ArrayList<ITree>();
