...
public class Defuse {
	public ArrayList<ITree> blocks1 = new ArrayList<ITree>();
	public ArrayList<ITree> blocks2 = new ArrayList<ITree>();
	public HashMap<ITree, ArrayList<ITree>> parBlockMap1 = new HashMap<ITree, ArrayList<ITree>>();
	public HashMap<ITree, ArrayList<ITree>> parBlockMap2 = new HashMap<ITree, ArrayList<ITree>>();
...
//						tar += String.valueOf(dstT.getRoot().getId());
	...
	public HashMap<ITree, ITree> searchBlockMap(TreeContext tc) throws Exception{
		HashMap<ITree, ITree> leaf2parblock_map = new HashMap<ITree, ITree>();
...
//			throw new Exception("Error def"+defRoot.getId()+tc.getTypeLabel(defRoot));
	...
	public SubTree checkMapping(SubTree st, MappingStore map, TreeContext tc2, List<SubTree> sub2) throws Exception {
		...
		HashMap<ITree, Integer> dRootCandidates = new HashMap<ITree, Integer>();
		int max_frequency = 0;
		int print_seedID = 0;
...
//				System.out.println("find def: "+node.getId());
	...
	public HashMap<ITree, ArrayList<Definition>> transfer2FunctionMap(ArrayList<Definition> defs, ITree root, TreeContext tc) {
		HashMap<ITree, ArrayList<Definition>> def_functionMap = new HashMap<ITree, ArrayList<Definition>>();
		for(Definition def : defs) {
		    ...
		    for(int i=0;i<pars.size();i++) {
		    	...
		    	if(type.equals("function")) {
		    		if(def_functionMap.get(par)==null) {
		    			ArrayList<Definition> tmps = new ArrayList<Definition>();
		    			tmps.add(def);
