...
public class Matrix {
	...
	private static ArrayList<Node> nodes1= new ArrayList<Node>();
	private static ArrayList<Node> nodes2= new ArrayList<Node>();
	private static ArrayList<Edge> edges1 = new ArrayList<Edge>();
	private static ArrayList<Edge> edges2 = new ArrayList<Edge>();
	private static Map<ITree, Integer> node2num1 = new HashMap<ITree, Integer>();
	private static Map<ITree, Integer> node2num2 = new HashMap<ITree, Integer>();
	private static Map<Integer, Integer> map = new HashMap<Integer, Integer>();
	private static Map<Integer, Integer> change = new HashMap<Integer, Integer>();
...
//		}
		...
		int[][] re = km.getMaxBipartie(recostmatrix,result);//KuhnMunkres算法计算最小代价的二分匹配
...
//		System.out.println("edgecost:"+ edgecost);
	 ...
	 public static int[][] CreatCostmatrix(int[][] graph1,int[][] graph2,ArrayList<Node> nodes1,ArrayList<Node> nodes2){
		 ...
		 double weight_out1;
		 double weight_out2;
		 Map<Integer, Double> outmap1 = new HashMap<Integer, Double>();
		 Map<Integer, Double> outmap2 = new HashMap<Integer, Double>();
     ...
     public static ArrayList<File> getFiles(String path){
 		...
 		if(fpath.exists()){
 			...
 			for(int i=0;i<files.length;i++){
 				if(files[i].isFile()&&files[i].getName().contains("dat")){
