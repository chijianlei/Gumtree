...
@Register(name = "sim", description = "Calculate the similarity",
        options = AbstractDiffClient.Options.class)
public class Sim extends AbstractDiffClient<Sim.Options> {
    ...
    public void run() throws Exception {
        ...
        int mappingSize = diff.mappings.size();
        float sim = (float)(2 * mappingSize) / (srcSize + dstSize);
